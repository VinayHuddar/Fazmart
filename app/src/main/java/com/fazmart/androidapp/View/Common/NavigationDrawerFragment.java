...
import com.fazmart.androidapp.View.UserAccount.MyAccountActivity;
...
public class NavigationDrawerFragment extends Fragment implements NavigationDrawerCallbacks {
    ...
    public void SetDefaultSelectedPosition (int defaultSelectedItemId) {
        ...
        if (userAccountData == null) {
            ...
            mNavDrawerAdapter_NotSignedIn.selectPosition(posSignedIn);
        }
    }
    ...
    void SignOut() {
        FazmartApplication.GetAPIService().GetLogout(new Callback<String>() {
            @Override
