...
public class NavDrawerItemList {
    ...
    public static final int MY_ACCOUNT_ITEM_ID = 1;
    public static final int MY_WISHLIST_ITEM_ID = 2;
    public static final int HOME_ITEM_ID = 3;
    public static final int BROWSE_ITEM_ID = 4;
    public static final int SEARCH_ITEM_ID = 5;
    public static final int MY_CART_ITEM_ID = 6;
    public static final int TRACK_MY_ORDER_ITEM_ID = 7;
    public static final int OFFERS_ITEM_ID = 8;
    public static final int REFER_FRIENDS_ITEM_ID = 9;
    public static final int CALL_US_ITEM_ID = 10;
    public static final int HELP_ITEM_ID = 11;
    public static final int PREFERENCES_ITEM_ID = 12;
